...
export function SelectedAssetsTrigger({
  ...
  return (
    <Button
      variant="outline"
      className="w-full sm:w-auto flex items-center justify-center gap-2 ghost-border bg-surface-container hover:bg-surface-high"
      onClick={onToggle}
    >
...
export function SelectedAssetsContent({
  ...
  return (
    <div className="rounded-xl bg-surface-low p-4 space-y-4">
      ...
      <div className="flex items-center justify-between pb-2 border-b border-outline-variant/15">
        ...
        {onClearAll && (
          <Button
            variant="ghost"
            size="sm"
            className="h-7 text-xs text-on-surface-variant hover:text-red-500"
            onClick={onClearAll}
          >
              ...
              {assets.map((asset) => {
                ...
                return (
                  <div
                    ...
                    className="flex items-center justify-between p-2.5 rounded-md bg-surface-container rounded-lg"
                  >
                    <div className="flex items-center gap-3 flex-1 min-w-0">
                      ...
                      {asset.type === "player" && player && (
                        <>
                          {player.headshot && (
                            <div className="bg-surface-highest p-1 rounded-full flex-shrink-0">
                              <Image
                      ...
                      {toTeam && (
                        <div className="flex items-center gap-1.5 flex-shrink-0">
                          <ArrowRightIcon className="h-4 w-4 text-on-surface-variant" />
                          {toTeam.logos?.[0] && (
                            <Image
                    ...
                    <Button
                      variant="ghost"
                      size="icon"
                      className="h-7 w-7 text-on-surface-variant hover:text-red-500 flex-shrink-0 ml-2"
